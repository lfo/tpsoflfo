package fr.devcoop.jee.tp5.impl;

import fr.devcoop.jee.tp5.Book;
import fr.devcoop.jee.tp5.BookDAO;
import fr.devcoop.jee.tp5.DAOException;
import fr.devcoop.jee.tp5.Person;
...
public class BookDAOJPAImpl implements BookDAO {
    ...
    public List<Person> getAuthors(Book book) {
        ...
        return persons;
//        Book bookinDb = entityManager.find(Book.class, book.getId());
//        return bookinDb.getAuthors();
    }
