...
public class BookEJBTest extends BusinessTestAbs {
    ...
    public void test() throws NamingException {
        BookEJBLocal bookEJBLocal = (BookEJBLocal) ctx.lookup("java:global/classes/BookEJB!com.ingesup.jee4.tp9.business.BookEJBLocal");
        Assert.assertNotNull(bookEJBLocal);
        BookEJBRemote bookEJBRemote = (BookEJBRemote) ctx.lookup("java:global/classes/BookEJB!com.ingesup.jee4.tp9.business.BookEJBRemote");
